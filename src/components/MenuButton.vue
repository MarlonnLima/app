<template>
  ...
  <nav class="nav">
    <ul class="pt-5">
      <li><a @:click="desmarcarCheck" href="#sobre">Sobre mim</a></li>
      <li><a @:click="desmarcarCheck" href="#servicos">Serviços</a></li>
      <li><a @:click="desmarcarCheck" href="#projetos">Projetos</a></li>
      <li><a @:click="desmarcarCheck" href="#contato">Contato</a></li>
    </ul>
  </nav>
</template>
